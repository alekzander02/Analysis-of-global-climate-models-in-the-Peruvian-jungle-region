...
setwd("C:/Users/alekz/OneDrive/Escritorio/Tecnicas_Final_Agrupado/Nuevo Datos/Pisco2/Precip")
...
Name_model <- substr(archivos,8,18)
Name_model
...
for (i in 1:length(obs$file)){
  ...
  ini$`MRI-ESM2-0_` = ini$`MRI-ESM2-0_`*86400
  ini$`NorESM2-LM_` = ini$`NorESM2-LM_`*86400
  ini$`UKESM1-0-LL` = ini$`UKESM1-0-LL`*86400 
  mod_sta[[i]] <- ini
